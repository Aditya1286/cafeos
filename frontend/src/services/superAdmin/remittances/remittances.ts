...
export const pay = (id: string): Promise<MarkPaidResponse> =>
  apiRequest(`/admin/remittances/${id}/pay`, 'PUT', {});

export const unpay = (id: string): Promise<UnmarkPaidResponse> =>
  apiRequest(`/admin/remittances/${id}/unpay`, 'PUT', {});
