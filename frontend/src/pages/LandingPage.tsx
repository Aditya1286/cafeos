...
export const LandingPage: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      quote:
        'The payments page is a game changer. I used to spend 2 hours every Sunday matching payments and fees. Now it’s all worked out for me.',
    },
    {
      name: 'Rohan Deshmukh',
      ...
      quote:
        'Our guests love the contactless QR menu. No app downloads needed — they just scan, order, and pay in 45 seconds.',
    },
  ];
          ...
          <div className="bg-white p-4 rounded-2xl border border-red-200 shadow-2xl shadow-red-600/10 flex items-center gap-3 text-xs max-w-sm">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-slate-600 truncate">
                Table 04 • 2x Cold Coffee, 1x Paneer Pizza
              </p>
            </div>
            <button
      ...
      <section className="relative pt-20 pb-28 px-4 lg:px-8 overflow-hidden bg-white border-b border-slate-200/80">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
            Customers order from their phone, orders go straight to your kitchen, and your money is
            easy to track — all in one place.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex items-center justify-center flex-wrap gap-8 md:gap-16 text-slate-700 font-bold text-sm md:text-base">
            <span className="flex items-center gap-2">
              <Coffee className="w-5 h-5 text-red-600" /> The Artisan Roastery
            </span>
            <span className="flex items-center gap-2">
              <UtensilsCrossed className="w-5 h-5 text-red-600" /> Espresso Lab
            </span>
            <span className="flex items-center gap-2">
              <Coffee className="w-5 h-5 text-red-600" /> Bean & Bloom
            </span>
            <span className="flex items-center gap-2">
              <Coffee className="w-5 h-5 text-red-600" /> Roast & Toast
            </span>
            <span className="flex items-center gap-2">
              <UtensilsCrossed className="w-5 h-5 text-red-600" /> Velvet Brews
            </span>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24 px-4 lg:px-8 space-y-28 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-600 text-sm leading-relaxed font-medium">
              Guests scan, order, and pay — no app download, no waiting for a server. Orders from a
              table's QR code go straight to the kitchen.
            </p>

            <ul className="space-y-3 text-xs text-slate-700 font-semibold">
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> Zero app
                installation required (works directly in mobile browser)
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> Supports item
                variants, dietary tags (Veg/Non-Veg), & extra toppings
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> Real-time order
                progress updates sent directly to guest screen
              </li>
            </ul>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center md:flex-row-reverse">
          ...
          <div className="space-y-6 order-1 md:order-2">
            ...
            <p className="text-slate-600 text-sm leading-relaxed font-medium">
              Orders flow straight to the kitchen. No printed tickets, no missed items, no lost
              checks. Keep chefs and servers in perfect sync.
            </p>

            <ul className="space-y-3 text-xs text-slate-700 font-semibold">
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> New orders pop up
                instantly
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> Colour-coded timers
                and a sound for each new order
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> Stock goes down on
                its own as orders are completed
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-600 text-sm leading-relaxed font-medium">
              Know exactly what you made, spent, and owe — without spreadsheets or a bookkeeper on
              standby. Our 3% fee per order (before GST) adds up, and you pay it to us every billing
              period.
            </p>

            <ul className="space-y-3 text-xs text-slate-700 font-semibold">
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> Every amount is
                exact, down to the paisa
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> A permanent record
                of your sales, our fees, and what you keep
              </li>
              <li className="flex items-center gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-red-600 flex-shrink-0" /> Built-in checks stop
                anyone being charged twice
              </li>
            </ul>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-4 text-xs text-zinc-300">
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong className="font-bold text-white">Up to 5</strong> Tables
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#2d2d30] flex items-center justify-center shrink-0">
                    ...
                    <span>
                      <strong className="font-bold text-white">Digital Menu</strong> & QR Code
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#2d2d30] flex items-center justify-center shrink-0">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong className="font-bold text-white">3%</strong> Fee per Order
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#2d2d30] flex items-center justify-center shrink-0">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong className="font-bold text-white">1 member</strong> seat
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4 text-xs text-zinc-700">
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong className="font-bold text-zinc-900">Up to 15</strong> Tables
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#e4e4e7] flex items-center justify-center shrink-0">
                    ...
                    <span>
                      <strong className="font-bold text-zinc-900">Live Kitchen</strong> Screen
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#e4e4e7] flex items-center justify-center shrink-0">
                    ...
                    <span>
                      <strong className="font-bold text-zinc-900">Automatic</strong> Stock Tracking
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#e4e4e7] flex items-center justify-center shrink-0">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong className="font-bold text-zinc-900">10 member</strong> seats
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4 text-xs text-zinc-300">
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong className="font-bold text-white">Unlimited Tables</strong> & Menus
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#2d2d30] flex items-center justify-center shrink-0">
                    ...
                    <span>
                      <strong className="font-bold text-white">Detailed Money</strong> Reports
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full bg-[#2d2d30] flex items-center justify-center shrink-0">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <span>
                      <strong className="font-bold text-white">Unlimited member</strong> seats
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-24 px-4 lg:px-8 max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xs text-slate-500 font-semibold">
            Everything you need to know about setting up {APP_NAME}
          </p>
        </div>
          ...
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              >
                <span>{faq.q}</span>
                <ChevronDown
                  className={`w-4 h-4 text-red-600 transition-transform ${openFaqIndex === idx ? 'rotate-180' : ''}`}
                />
              </button>
              {openFaqIndex === idx && (
      ...
      <section className="py-24 px-4 lg:px-8 text-center relative overflow-hidden bg-gradient-to-b from-slate-900 to-black text-white">
        <div className="max-w-4xl mx-auto relative z-10 space-y-6">
          ...
          <p className="text-sm md:text-base text-slate-300 max-w-2xl mx-auto font-medium">
            Join 500+ businesses using QR ordering, a live kitchen screen and simple money tracking
            today.
          </p>
