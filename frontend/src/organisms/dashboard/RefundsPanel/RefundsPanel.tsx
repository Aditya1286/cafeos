...
export const RefundsPanel = ({
  orders, loading, insights, pagination, onPageChange, onPageSizeChange,
  searchQuery, onSearchChange, paymentStatusFilter, onPaymentStatusFilterChange,
  onRefresh, onViewHistory, onMarkRefunded
}: RefundsPanelProps) => {
    ...
    },
    {
      ...
      render: (o) => (
        <div className="flex items-center justify-end gap-1.5">
          <button onClick={() => onViewHistory(o)} className="px-3 py-1.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white text-xs font-black transition-colors flex items-center gap-1">
